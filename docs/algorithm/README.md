...
- **`phase_space_crystal_lattice_algorithm.md`** — The canonical 1+1-D
  ...
  `../supplement/phase_space_crystal_lattice_supplement.md` for the algebraic
...
- **`multi_body_extension.md`** — Forward-looking extension of the 1+1-D spec
...
- **`density_matrix_microdynamics_algorithm.md`** — Forward-looking
...
- **`phase_alignment_microdynamics_algorithm.md`** — Specification of the
...
`phase_space_crystal_lattice_algorithm.md` alone is enough to reproduce every
